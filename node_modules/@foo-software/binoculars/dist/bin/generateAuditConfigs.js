...
for (const audit of audits) {
    shelljs_1.default.exec(`npm run generate auditConfig ${audit.name} ${audit.path}`);
    shelljs_1.default.exec('npm run test');
}
//# sourceMappingURL=generateAuditConfigs.js.map