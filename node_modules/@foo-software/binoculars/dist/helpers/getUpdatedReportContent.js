...
exports.default = (reportContent) => {
    ...
    content = content.replace(lhGeneratedPrefix, `${lhGeneratedPrefix}${hideStyle}`);
    return replaceLinks_1.default(content);
};
//# sourceMappingURL=getUpdatedReportContent.js.map