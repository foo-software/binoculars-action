...
var _default = async ({
  ...
  try {
    ...
    const results = !timeout ? await (0, _lighthouse.default)(url, options, fullConfig) : await Promise.race([createTimeout(timeout), (0, _lighthouse.default)(url, options, fullConfig)]);
